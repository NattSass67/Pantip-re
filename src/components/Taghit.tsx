  ...
  const hitList = content?.map((object, index) => {
    return (
      <a
        ...
        key={index}
        className="m-2 flex h-24 w-full flex-none flex-col overflow-hidden rounded-lg border border-gray-200 bg-white shadow transition ease-in-out hover:-translate-y-1 dark:border-gray-700 dark:bg-gray-800"
      >

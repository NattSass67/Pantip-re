...
const SearchBar = () => {
  ...
  const isActive = useAppSelector((state) => state.mySession.reachTop);
  ...
  return (
    <div className="w-full max-w-lg">
      <div
        className={`z-20 flex w-full max-w-lg items-center justify-center rounded-full border border-gray-300 shadow-xl transition ease-in-out ${isActive ? '' : ''}`}
      >
        <input
          type="text"
          value={searchString}

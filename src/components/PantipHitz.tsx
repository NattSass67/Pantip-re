...
const PantipHitz = () => {
  ...
  const hitzList = content?.map((object) => {
    return (
      <a
      ...
      >
        <img
          src={
            object.thumbnail_url ? object.thumbnail_url : 'apple-touch-icon.png'
          }
          className="w-24"
          alt="icon"
        />
        <div className="grid w-full grid-rows-3">
          <div className="row-span-2 overflow-hidden">
            <p className="p-2 text-center text-sm text-rose-700 dark:text-gray-400">
              {object.title}
            </p>
          </div>
          <div className="row-span-1 float-right m-2 flex flex-row-reverse text-xs">
            ...
            <div>{object.views_count} views</div>
            <div>
              <svg
                width="16px"
                height="16px"
  ...
  return (
    <div className="mt-4 flex flex-col bg-rose-50 p-4">
      <div className="text-lg font-semibold text-rose-700">Pantip Hitz</div>
